...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <div class="flex mb-3 mt-6 ml-3">
                <p class="text-2xl font-bold">Today</p>
            </div>
            <div class="grid grid-cols-1 gap-3 mb-4">
                <div class="flex items-center justify-between rounded mb-3 p-3">
                    <div>
                        <img src="https://i.ibb.co/TvzdXhJ/Group-17.png" alt="" style="height: 80px;">
                    </div>
                    <div class="mr-auto ml-5">
                        <h2 class="font-bold text-lg">All i See Is You</h2>
                        <h2 class="font-semibold text-base text-gray-600">Blake Lively . Horror</h2>
                        <h2 class="font-semibold text-base text-gray-600">12.00 - 12.45</h2>
                    </div>
                    <div>
                        <h2 class="font-bold text-2xl mr-5 text-center">50%</h2>
                    </div>
                </div>
                <hr class="h-px bg-gray-200 border-0 bg-gray-500">
                <div class="flex items-center justify-between rounded mb-3 p-3">
                    <div>
                        <img src="https://i.ibb.co/YRLK0cN/Group-18.png" alt="" style="height: 80px;">
                    </div>
                    <div class="mr-auto ml-5">
                        <h2 class="font-bold text-lg">The Host</h2>
                        <h2 class="font-semibold text-base text-gray-600">Bong Joon-Jo . Horror</h2>
                        <h2 class="font-semibold text-base text-gray-600">10.00 - 10.40</h2>
                    </div>
                    <div>
                        <h2 class="font-bold text-2xl mr-5 text-center">70%</h2>
                    </div>
                </div>
                <hr class="h-px bg-gray-200 border-0 bg-gray-500">
                <div class="flex items-center justify-between rounded mb-3 p-3">
                    <div>
                        <img src="https://i.ibb.co/mS4y1Bs/Group-19.png" alt="" style="height: 80px;">
                    </div>
                    <div class="mr-auto ml-5">
                        <h2 class="font-bold text-lg">Glass</h2>
                        <h2 class="font-semibold text-base text-gray-600">Night Shyamalan . Action</h2>
                        <h2 class="font-semibold text-base text-gray-600">08.15 - 09.15</h2>
                    </div>
                    <div>
                        <h2 class="font-bold text-2xl mr-5 text-center">50%</h2>
                    </div>
                ...
                <div class="flex items-center justify-between rounded mb-3 p-3">
                    <div>
                        <img src="https://i.ibb.co/XkPwSBP/Group-20.png" alt="" style="height: 80px;">
                    </div>
                    <div class="mr-auto ml-5">
                        <h2 class="font-bold text-lg">Night Manager</h2>
                        <h2 class="font-semibold text-base text-gray-600">High Laurie . Action</h2>
                        <h2 class="font-semibold text-base text-gray-600">05.00 - 07.00</h2>
                    </div>
                    <div>
                        <h2 class="font-bold text-2xl mr-5 text-center">100%</h2>
                    </div>
                </div>
                <hr class="h-px bg-gray-200 border-0 bg-gray-500">
            </div>
            ...
            <div class="grid grid-cols-1 gap-3 mb-4">
                <div class="flex items-center justify-between rounded mb-3 p-3">
                    <div>
                        <img src="https://i.ibb.co/3RryN9K/Frame-40.png" alt="" style="height: 80px;">
                    </div>
                    <div class="mr-auto ml-5">
                        <h2 class="font-bold text-lg">The School</h2>
                        <h2 class="font-semibold text-base text-gray-600">Alex Juidex . Horror</h2>
                        <h2 class="font-semibold text-base text-gray-600">23.30 - 23.40</h2>
                    </div>
                    <div class="text-center">
                        <h2 class="font-bold text-2xl mr-5">5%</h2>
                    </div>
                </div>
                <hr class="h-px bg-gray-200 border-0 bg-gray-500">
                <div class="flex items-center justify-between rounded mb-3 p-3">
                    <div>
                        <img src="https://i.ibb.co/z2Z6pyf/Frame-40-1.png" alt="" style="height: 80px;">
                    </div>
                    <div class="mr-auto ml-5">
                        <h2 class="font-bold text-lg">Shortwave</h2>
                        <h2 class="font-semibold text-base text-gray-600">Juanitta Kingling . Horror</h2>
                        <h2 class="font-semibold text-base text-gray-600">21.15 - 21.30</h2>
                    </div>
                    <div>
                        <h2 class="font-bold text-2xl mr-5 text-center">20%</h2>
                    </div>
                </div>
                <hr class="h-px bg-gray-200 border-0 bg-gray-500">
                <div class="flex items-center justify-between rounded mb-3 p-3">
                    <div>
                        <img src="https://i.ibb.co/brDMyjH/Group-21.png" alt="" style="height: 80px;">
                    </div>
                    <div class="mr-auto ml-5">
                        <h2 class="font-bold text-lg">Candles</h2>
                        <h2 class="font-semibold text-base text-gray-600">John R. Penn . Horror</h2>
                        <h2 class="font-semibold text-base text-gray-600">19.00 - 20.00</h2>
                    </div>
                    <div>
                        <h2 class="font-bold text-2xl mr-5 text-center">90%</h2>
                    </div>
                </div>
                <hr class="h-px bg-gray-200 border-0 bg-gray-500">
            </div>
