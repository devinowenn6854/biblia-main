                     ...
                     <div class="card-body ">
                        <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="mb-3">
                              ...
                              <select class="form-select" aria-label="Default select example" id="genre" name="genre" value="{{ $data->genre }}">{{ $data->genre }}
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="des" name="des" value="{{ $data->des }}">
                           </div>
                           <div class="mb-3">
                           ...
                           <div class="mb-3">
                              ...
                              <input type="file" class="form-control" id="isi" name="isi" value="{{ $data->isi }}">
                           </div>
                           <button type="submit" class="btn btn-primary text-black mt-3">Edit</button>
                        </form>
                     </div>
                  </div>
               </div>
